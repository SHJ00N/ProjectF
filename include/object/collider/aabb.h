...
public:
    ...
    bool isIntersectsAABB(const Collider &other) const final;

    // world space aabb
    AABB GetGlobalAABB(const class Transform& transform) const;
    void UpdateGlobalAABB(AABB& out, const class Transform& transform) const;
};